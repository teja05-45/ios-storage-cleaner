...
final class ReviewStoreAggregationTests: XCTestCase {
    ...
    func test_recoverableBytes_sumsSelectedAcrossAllCategories() {
        ...
        var toggled2 = store.similarPhotoGroups[0]
        toggled2.toggleSelection(for: "d")
        store.similarPhotoGroups[0] = toggled2
    ...
    func test_currentSelection_aggregatesAcrossExactAndSimilarWithoutOverlap() {
        ...
        var t1 = store.exactDuplicateGroups[0]
        t1.toggleSelection(for: "b")
        store.exactDuplicateGroups[0] = t1
        var t2 = store.similarPhotoGroups[0]
        t2.toggleSelection(for: "d")
        store.similarPhotoGroups[0] = t2
